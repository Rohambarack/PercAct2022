...
```{r}
file_names <- dir("C:/github/PercAct2022/mousetracking/dog",full.names = T) #where you have your files

your_data_frame <- do.call(rbind,lapply(file_names,read_csv))

d <- read_opensesame( directory = "C:/github/PercAct2022/mousetracking/dog")
```

```{r}
m <- mt_import_mousetrap(your_data_frame)
```
...
```{r}
d1 <- read_csv("C:/github/PercAct2022/mousetracking/dog/subject-1.csv")
d2<- read_csv("C:/github/PercAct2022/mousetracking/dog/subject-2.csv")
d3<- read_csv("C:/github/PercAct2022/mousetracking/dog/subject-3.csv")
d4<- read_csv("C:/github/PercAct2022/mousetracking/dog/subject-4.csv")
```
```{r}
d4 <- d4 %>% 
  mutate(initiation_time = ifelse(initiation_time == 0,1,initiation_time),
         initiation_time_Mouse = ifelse(initiation_time_Mouse == 0,1,initiation_time_Mouse))
...
m <- mt_exclude_initiation(m,use = "trajectories", timestamps = "timestamps")
